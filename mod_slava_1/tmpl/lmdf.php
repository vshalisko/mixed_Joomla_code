...
<fieldset class="lmdfInputP6 lmdfInputC0" style="display: none;">
	<legend class="lmdfInputP6 lmdfInputC0" style="display: none;"><!--Especifica la detalles y superficie de la obra-->Detalles adicionales</legend>
...
<span class="lmdfSelectorL30 lmdfSelectorL30" style="display: none;"><br /></span>
...
<span class="lmdfSelectorL25 lmdfSelectorL21" style="display: none;"><br /></span>
	<div class="row-fluid">
		<div class="span4 lmdfSelectorP16" style="display: none;">
			<fieldset class="lmdfSelectorP16">
				...
				<label class="lmdfSelectorP16">
					<input type="radio" name="lmdfSelectorP16" value="reparación mayor o adaptación" /> Fuera del centro histórico
				</label>
				</div>
			</fieldset>
		</div>
		<div class="span4 lmdfSelectorP16A" style="display: none;">
			<fieldset class="lmdfSelectorP16A">
				...
				<label class="lmdfSelectorP16A">
					<input type="radio" name="lmdfSelectorP16A" value="reparación mayor o adaptación" /> Fuera del centro histórico
				</label>
				</div>
			</fieldset>
		</div>
