			...
			{ 
				"option" : "Grupo 1 Usos",
		  		"dependencies" : [ "lmdfInputS0", "lmdfInputS2", "lmdfInputS3", "lmdfInputS4", "lmdfInputS5",  "lmdfInputS6", "lmdfInputS7",
						...
						"lmdfInputPR0","lmdfSelectorD3","docRequired1" ]
			},                                                                  
			{ 
			...
			{ 
				"option" : "Grupo 3 Licencia",
		  		"dependencies" : [ "lmdfInputL0","lmdfInputL1","lmdfInputL2","lmdfInputL3","lmdfInputL4","lmdfInputL5",
						...
						"lmdfInputL20", 
						"lmdfInputD0","lmdfSelectorD3","docRequired1" ]
			},                                                                    
			{ 
...
// ====nuevo selector de licencias========
	...
	{ 
		...
		"dependencies" : [ "lmdfSelectorL25", "lmdfInputL23"  ] 
	} ,
	{ 
		"type" : "input",
		"name" : "lmdfInputL5",
	...
	{ 
		...
		"dependencies" : [ "lmdfInputL23", "lmdfSelectorL30" ] 
	} ,
	{ 
		"type" : "input",
		"name" : "lmdfInputL7",
