 ...
 * @author 		Modified by Viacheslav Shalisko vshalisko@gmail.com
...
class modQlformHelper
{
	 ...
	 *
	 */	
	public function saveupdateToDatabase($table,$data,$primary,$paramsDatabaseExternal=array())
	{
		//echo "<pre>";print_r($paramsDatabaseExternal);die;print_r($this->arrTableFields);die;
        $data=array_intersect_key($data,$this->arrTableFields);
        if (0==count($paramsDatabaseExternal))$this->obj_database->saveupdate($table,$data,$primary);
        else $this->obj_databaseexternal->saveupdate($table,$data,$primary);
		return true;
	}
	/**
	 * Method for checking database     
